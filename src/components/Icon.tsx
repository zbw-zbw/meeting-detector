...
export function IconArrowUp({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
export function IconPrinter({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
export function IconTrophy({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
/* ─── Favorite / Star ─── */
export function IconStar({ size = 24, className, fill, ...p }: Omit<IconProps, "fill"> & { fill?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
